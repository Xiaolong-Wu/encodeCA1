    ...
    for r2=2:nEpoch-1
        ...
        if exist(path_data_train_group_temp1,'file')
            ...
            for r3=1:nTrain
                ...
                of_target(r3,:)=[cord_location1,cord_posture1,cord_direction1,cord_quadrant,cord_location2,cord_posture2,cord_direction2];
            end
