...
# attention
n_layer = 1  # always 1, do not change
d_model = d_feature2
n_head = d_cnnSize
d_k = d_feature2
d_v = d_feature2
...
path_4_3 = os.path.join(path_4, 'CA1')
...
if not os.path.isfile(path_4_2):
    ...
    CA1.eval()
    if type3_model == 3 or type3_model == 6:
        CA1.model02.layer_stack[0].pos_ffn.w = nn.Linear(d_model, d_model)
        shutil.move('./model', path_4_3)
...
if type3_model == 3 or type3_model == 6:
    CA1.model02.layer_stack[0].pos_ffn.w = KAN.loadckpt(os.path.join(path_4_3, '0.0'))
CA1.eval()
